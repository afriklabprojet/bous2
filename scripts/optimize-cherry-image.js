...
const inputPath = path.join(__dirname, "../public/images/cherry-wood.jpg");
const outputPath = path.join(
  __dirname,
  "../public/images/cherry-wood-optimized.jpg"
);

console.log("Optimizing cherry-wood.jpg...");
...
sharp(inputPath)
  ...
  .then((info) => {
    ...
    console.log(
      "Savings:",
      ((1 - info.size / fs.statSync(inputPath).size) * 100).toFixed(1) + "%"
    );
