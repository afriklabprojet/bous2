...
export const translations: Record<Language, Translation> = {
  fr: {
    ...
    order: {
      ...
      woodTypes: {
        maple: "Bois d'Érable Premium - 130$",
        birch: "Bois de Bouleau Blanc - 120$",
        mixed: "Bois Mélangé Économique - 95$",
        cherry: "Bois de Merisier - 140$",
        ash: "Bois de Frêne - 115$",
        green: "Bois Vert à Sécher - 80$",
        premium: "Mélange Premium - 125$",
        pellets: "Granulés Premium - 260$/palette",
        whiteAsh: "Frêne Blanc - 125$",
        yellowBirch: "Bouleau Jaune - 145$",
      },
      paymentMethods: {
  ...
  en: {
    ...
    order: {
      ...
      woodTypes: {
        maple: "Premium Maple Wood - $130",
        birch: "White Birch Wood - $120",
        mixed: "Economy Mixed Wood - $95",
        cherry: "Cherry Wood - $140",
        ash: "Ash Wood - $115",
        green: "Green Wood to Season - $80",
        premium: "Premium Mix - $125",
        pellets: "Premium Pellets - $260/pallet",
        whiteAsh: "White Ash - $125",
        yellowBirch: "Yellow Birch - $145",
      },
      paymentMethods: {
