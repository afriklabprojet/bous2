        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>{language === 'fr' ? 'Transport de marchandises diverses' : 'Transport of various goods'}</li>
              <li>{language === 'fr' ? 'Chauffeurs expérimentés' : 'Experienced drivers'}</li>
              <li>{language === 'fr' ? 'Service ponctuel et fiable' : 'Punctual and reliable service'}</li>
              <li>{language === 'fr' ? 'Couverture régionale complète' : 'Complete regional coverage'}</li>
            </ul>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600">
                  {language === 'fr' ? 'Chaleur intense et longue durée' : 'Intense heat and long duration'}
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-heading font-semibold text-lg mb-2 text-green-800">
                ...
                <p className="text-sm text-gray-600">
                  {language === 'fr' ? 'Combustion propre et efficace' : 'Clean and efficient combustion'}
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-heading font-semibold text-lg mb-2 text-green-800">
                ...
                <p className="text-sm text-gray-600">
                  {language === 'fr' ? 'Mélange équilibré et économique' : 'Balanced and economical mix'}
                </p>
              </div>
            </div>
          </div>
