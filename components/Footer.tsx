          ...
          <div>
            ...
            <div className="space-y-3 text-white/80">
              ...
              <a
                ...
                className="text-white/80 hover:text-white transition-colors inline-flex items-center space-x-3"
              >
                <svg
                ...
                <span className="break-all">contact@jsgc.store</span>
              </a>
              <a
              ...
              >
                ...
                <span className="break-all">+1 581 681 1180</span>
              </a>
            </div>
          </div>
